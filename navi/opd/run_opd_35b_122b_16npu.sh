...
# Qwen3.5-122B-A10B teacher on 16 Ascend NPUs.
#
...
TEACHER_MODEL=${TEACHER_MODEL:-/home/ma-user/work/models/Qwen3.5-122B-A10B}
...
OUT_DIR=${OUT_DIR:-${PROJECT_DIR}/outputs/opd_35b_122b_16npu}
...
LOG_FILE=${LOG_FILE:-${PROJECT_DIR}/logs/opd_35b_122b_16npu_${start_time}.log}
...
TRAINER=(
    ...
    trainer.experiment_name=qwen3_5_35b_from_122b_a10b_16npu
